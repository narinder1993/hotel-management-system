...
namespace WindowsFormsApplication5 {
    ...
    public partial class Database1DataSet8 : global::System.Data.DataSet {
        ...
        public partial class patientDataTable : global::System.Data.TypedTableBase<patientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public patientRow AddpatientRow(string name, int age, string sex, string address, string doctor, int room, int balance_due) {
            ...
            private void InitClass() {
                ...
                this.columnbalance_due = new global::System.Data.DataColumn("balance_due", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class patientRow : global::System.Data.DataRow {
            ...
            public int room {
                get {
                    try {
                        return ((int)(this[this.tablepatient.roomColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'room\' in table \'patient\' is DBNull.", e);
                    }
                }
                set {
            ...
            public int balance_due {
                get {
                    try {
                        return ((int)(this[this.tablepatient.balance_dueColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'balance_due\' in table \'patient\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablepatient.balance_dueColumn] = value;
                }
            }
            ...
            public bool IsroomNull() {
                return this.IsNull(this.tablepatient.roomColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetroomNull() {
                this[this.tablepatient.roomColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool Isbalance_dueNull() {
                return this.IsNull(this.tablepatient.balance_dueColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void Setbalance_dueNull() {
                this[this.tablepatient.balance_dueColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication5.Database1DataSet8TableAdapters {
    ...
    public partial class patientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[patient] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_doctor = 1 AND [doctor] IS NULL) OR ([doctor] = @Original_doctor)) AND ((@IsNull_room = 1 AND [room] IS NULL) OR ([room] = @Original_room)) AND ((@IsNull_balance_due = 1 AND [balance_due] IS NULL) OR ([balance_due] = @Original_balance_due)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_balance_due", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "balance_due", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[patient] ([name], [age], [sex], [address], [doctor], [room], [balance_due]) VALUES (@name, @age, @sex, @address, @doctor, @room, @balance_due);
SELECT id, name, age, sex, address, doctor, room, balance_due FROM patient WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@balance_due", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "balance_due", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[patient] SET [name] = @name, [age] = @age, [sex] = @sex, [address] = @address, [doctor] = @doctor, [room] = @room, [balance_due] = @balance_due WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_doctor = 1 AND [doctor] IS NULL) OR ([doctor] = @Original_doctor)) AND ((@IsNull_room = 1 AND [room] IS NULL) OR ([room] = @Original_room)) AND ((@IsNull_balance_due = 1 AND [balance_due] IS NULL) OR ([balance_due] = @Original_balance_due)));
SELECT id, name, age, sex, address, doctor, room, balance_due FROM patient WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@balance_due", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "balance_due", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_balance_due", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "balance_due", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, age, sex, address, doctor, room, balance_due FROM dbo.patient";
        ...
        public virtual int Fill(Database1DataSet8.patientDataTable dataTable) {
        ...
        public virtual Database1DataSet8.patientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet8.patientDataTable dataTable = new Database1DataSet8.patientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet8.patientDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_sex, string Original_address, string Original_doctor, global::System.Nullable<int> Original_room, global::System.Nullable<int> Original_balance_due) {
            ...
            if ((Original_balance_due.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((int)(Original_balance_due.Value));
            }
            else {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> age, string sex, string address, string doctor, global::System.Nullable<int> room, global::System.Nullable<int> balance_due) {
            if ((name == null)) {
            ...
            if ((balance_due.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((int)(balance_due.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> balance_due, 
                    int Original_id, 
                    ...
                    global::System.Nullable<int> Original_balance_due, 
                    int id) {
            if ((name == null)) {
            ...
            if ((balance_due.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(balance_due.Value));
            }
            else {
            ...
            if ((Original_room.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(Original_room.Value));
            }
            else {
            ...
            if ((Original_balance_due.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_balance_due.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> age, string sex, string address, string doctor, global::System.Nullable<int> room, global::System.Nullable<int> balance_due, int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_sex, string Original_address, string Original_doctor, global::System.Nullable<int> Original_room, global::System.Nullable<int> Original_balance_due) {
            return this.Update(name, age, sex, address, doctor, room, balance_due, Original_id, Original_name, Original_age, Original_sex, Original_address, Original_doctor, Original_room, Original_balance_due, Original_id);
        }
    }
