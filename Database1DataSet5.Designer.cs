...
namespace WindowsFormsApplication5 {
    ...
    public partial class Database1DataSet5 : global::System.Data.DataSet {
        ...
        public partial class doctorsDataTable : global::System.Data.TypedTableBase<doctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public doctorsRow AdddoctorsRow(string name, int age, string qualification, string address, int salary, string number) {
        ...
        public partial class doctorsRow : global::System.Data.DataRow {
            ...
            public string number {
                get {
                    try {
                        return ((string)(this[this.tabledoctors.numberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'number\' in table \'doctors\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabledoctors.numberColumn] = value;
                }
            }
            ...
            public bool IsnumberNull() {
                return this.IsNull(this.tabledoctors.numberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetnumberNull() {
                this[this.tabledoctors.numberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication5.Database1DataSet5TableAdapters {
    ...
    public partial class doctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[doctors] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_qualification = 1 AND [qualification] IS NULL) OR ([qualification] = @Original_qualification)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[doctors] ([name], [age], [qualification], [address], [salary], [number]) VALUES (@name, @age, @qualification, @address, @salary, @number);
SELECT id, name, age, qualification, address, salary, number FROM doctors WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[doctors] SET [name] = @name, [age] = @age, [qualification] = @qualification, [address] = @address, [salary] = @salary, [number] = @number WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_qualification = 1 AND [qualification] IS NULL) OR ([qualification] = @Original_qualification)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)));
SELECT id, name, age, qualification, address, salary, number FROM doctors WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, age, qualification, address, salary, number FROM dbo.doctors";
        ...
        public virtual int Fill(Database1DataSet5.doctorsDataTable dataTable) {
        ...
        public virtual Database1DataSet5.doctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet5.doctorsDataTable dataTable = new Database1DataSet5.doctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet5.doctorsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_qualification, string Original_address, global::System.Nullable<int> Original_salary, string Original_number) {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> age, string qualification, string address, global::System.Nullable<int> salary, string number) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, global::System.Nullable<int> age, string qualification, string address, global::System.Nullable<int> salary, string number, int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_qualification, string Original_address, global::System.Nullable<int> Original_salary, string Original_number, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> age, string qualification, string address, global::System.Nullable<int> salary, string number, int Original_id, string Original_name, global::System.Nullable<int> Original_age, string Original_qualification, string Original_address, global::System.Nullable<int> Original_salary, string Original_number) {
            return this.Update(name, age, qualification, address, salary, number, Original_id, Original_name, Original_age, Original_qualification, Original_address, Original_salary, Original_number, Original_id);
        }
    }
