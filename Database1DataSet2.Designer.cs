...
namespace WindowsFormsApplication5 {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class doctorsDataTable : global::System.Data.TypedTableBase<doctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public doctorsRow AdddoctorsRow(string name, int salary, string number) {
...
namespace WindowsFormsApplication5.Database1DataSet2TableAdapters {
    ...
    public partial class doctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[doctors] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[doctors] ([name], [salary], [number]) VALUES (@name, @salary, " +
                "@number);\r\nSELECT id, name, salary, number FROM doctors WHERE (id = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[doctors] SET [name] = @name, [salary] = @salary, [number] = @number WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)));
SELECT id, name, salary, number FROM doctors WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, salary, number FROM dbo.doctors";
        ...
        public virtual int Fill(Database1DataSet2.doctorsDataTable dataTable) {
        ...
        public virtual Database1DataSet2.doctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.doctorsDataTable dataTable = new Database1DataSet2.doctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.doctorsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, global::System.Nullable<int> Original_salary, string Original_number) {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> salary, string number) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, global::System.Nullable<int> salary, string number, int Original_id, string Original_name, global::System.Nullable<int> Original_salary, string Original_number, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> salary, string number, int Original_id, string Original_name, global::System.Nullable<int> Original_salary, string Original_number) {
            return this.Update(name, salary, number, Original_id, Original_name, Original_salary, Original_number, Original_id);
        }
    }
