...
namespace WindowsFormsApplication5 {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class nurseDataTable : global::System.Data.TypedTableBase<nurseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public nurseRow AddnurseRow(string Name, int Salary, string Contact) {
...
namespace WindowsFormsApplication5.Database1DataSet3TableAdapters {
    ...
    public partial class nurseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[nurse] WHERE (([empid] = @Original_empid) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[nurse] ([Name], [Salary], [Contact]) VALUES (@Name, @Salary, @" +
                "Contact);\r\nSELECT empid, Name, Salary, Contact FROM nurse WHERE (empid = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[nurse] SET [Name] = @Name, [Salary] = @Salary, [Contact] = @Contact WHERE (([empid] = @Original_empid) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)));
SELECT empid, Name, Salary, Contact FROM nurse WHERE (empid = @empid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT empid, Name, Salary, Contact FROM dbo.nurse";
        ...
        public virtual int Fill(Database1DataSet3.nurseDataTable dataTable) {
        ...
        public virtual Database1DataSet3.nurseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.nurseDataTable dataTable = new Database1DataSet3.nurseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.nurseDataTable dataTable) {
        ...
        public virtual int Delete(int Original_empid, string Original_Name, global::System.Nullable<int> Original_Salary, string Original_Contact) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Salary, string Contact) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Salary, string Contact, int Original_empid, string Original_Name, global::System.Nullable<int> Original_Salary, string Original_Contact, int empid) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Salary, string Contact, int Original_empid, string Original_Name, global::System.Nullable<int> Original_Salary, string Original_Contact) {
            return this.Update(Name, Salary, Contact, Original_empid, Original_Name, Original_Salary, Original_Contact, Original_empid);
        }
    }
